...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "9LjiF8VuugXuJLdSAqsqaZjh8";       // Change this
    public static final String REST_CONSUMER_SECRET = "Rv0g0H5eteSntZUj2WwwzW1niq4mOGW1Doz9u8HM9zvVcu260v"; // Change this
